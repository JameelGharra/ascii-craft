...
// // in case of using standard tree building algorithm, I switched for better bandwidth performance
// // kept since I might use it in the future

// // won't get to that even if are using 16-bit colors, just for experimenting
