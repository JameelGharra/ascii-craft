...
type HuffmanResultTable struct {
...
func NewHuffmanResultTable() *HuffmanResultTable {
	return &HuffmanResultTable{
...
func (h *HuffmanResultTable) Left() {
	h.buffer[h.currentLen] = 0
	h.currentLen++
}

func (h *HuffmanResultTable) Right() {
	h.buffer[h.currentLen] = 1
	h.currentLen++
}

func (h *HuffmanResultTable) Back() { // either way no need to delete anything
	h.currentLen--
}

func (h *HuffmanResultTable) Update(value int) {
